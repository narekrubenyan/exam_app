                    ...
                    <form  method="POST" action="{{ route('questions.update', $question->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ __('questions.editQuestion') }}</h3>
                            </div>

                            <div class="card-body">
                                <div class="form-group">
                                    <label for="questionText">{{ __('questions.question') }}</label>
                                    <input
                                        type="text"
                                        class="form-control"
                                        id="questionText"
                                        ...
                                        placeholder="{{ __('questions.question') }}"
                                    >
                                    @error('title')
                                ...
                                <div class="card card-default {{ (count($question->statements)) ? '': 'collapsed-card'; }}">
                                    <div class="card-header">
                                        <h3 class="card-title">{{ __('questions.statements') }}</h3>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <input
                                                        ...
                                                        placeholder="{{ __('questions.statement') }} 1"
                                                    ...
                                                    <input
                                                        type="text" class="form-control mt-1" name="statements[]"
                                                        placeholder="{{ __('questions.statement') }} 2"
                                                    ...
                                                    <input
                                                        type="text" class="form-control mt-1" name="statements[]"
                                                        placeholder="{{ __('questions.statement') }} 3"
                                                    ...
                                                    <input
                                                        type="text" class="form-control mt-1" name="statements[]"
                                                        placeholder="{{ __('questions.statement') }} 4"
                                                    ...
                                                    <input
                                                        type="text" class="form-control mt-1" name="statements[]"
                                                        placeholder="{{ __('questions.statement') }} 5"
                                ...
                                <div class="col-lg-6">
                                    <h3 class="card-title mb-2">{{ __('questions.answers') }}</h3>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary">{{ __('questions.submit') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
